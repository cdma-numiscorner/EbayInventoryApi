...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ebay.com/sell/inventory/v1';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\EbayInventoryClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.16.1' . PHP_EOL;
            ...
            [
                ...
                "variables" => [
                    "basePath" => [
                        ...
                        "default_value" => "/sell/inventory/v1",
                    ]
                ]
            ]
        ];
