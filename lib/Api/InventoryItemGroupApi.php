...
class InventoryItemGroupApi
{
     ...
     * @param  string $inventory_item_group_key This path parameter specifies the unique identifier of the inventory item group being created or updated. This identifier is defined by the seller.&lt;br&gt;&lt;br&gt;This value cannot be changed once it is set.&lt;br&gt;&lt;br&gt;&lt;b&gt;Maximum length:&lt;/b&gt; 50 (required)
     ...
     */
    public function createOrReplaceInventoryItemGroup($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
    {
        list($response) = $this->createOrReplaceInventoryItemGroupWithHttpInfo($content_language, $inventory_item_group_key, $content_type, $inventory_item_group);
        return $response;
    }
     ...
     */
    public function createOrReplaceInventoryItemGroupWithHttpInfo($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
    {
        $request = $this->createOrReplaceInventoryItemGroupRequest($content_language, $inventory_item_group_key, $content_type, $inventory_item_group);
     ...
     */
    public function createOrReplaceInventoryItemGroupAsync($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
    {
        return $this->createOrReplaceInventoryItemGroupAsyncWithHttpInfo($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrReplaceInventoryItemGroupAsyncWithHttpInfo($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
    {
        $returnType = '\OpenAPI\EbayInventoryClient\Model\BaseResponse';
        $request = $this->createOrReplaceInventoryItemGroupRequest($content_language, $inventory_item_group_key, $content_type, $inventory_item_group);
     ...
     */
    public function createOrReplaceInventoryItemGroupRequest($content_language, $inventory_item_group_key, $content_type, $inventory_item_group)
    {
     ...
     * @throws \OpenAPI\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayInventoryClient\Model\InventoryItemGroup|\OpenAPI\EbayInventoryClient\Model\Error|\OpenAPI\EbayInventoryClient\Model\Error|\OpenAPI\EbayInventoryClient\Model\Error
     */
     ...
     * @throws \OpenAPI\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayInventoryClient\Model\InventoryItemGroup|\OpenAPI\EbayInventoryClient\Model\Error|\OpenAPI\EbayInventoryClient\Model\Error|\OpenAPI\EbayInventoryClient\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
