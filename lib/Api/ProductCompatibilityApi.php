...
class ProductCompatibilityApi
{
     ...
     */
    public function createOrReplaceProductCompatibility($sku, $content_language, $compatibility)
    {
        list($response) = $this->createOrReplaceProductCompatibilityWithHttpInfo($sku, $content_language, $compatibility);
        return $response;
    }
     ...
     */
    public function createOrReplaceProductCompatibilityWithHttpInfo($sku, $content_language, $compatibility)
    {
        $request = $this->createOrReplaceProductCompatibilityRequest($sku, $content_language, $compatibility);
     ...
     */
    public function createOrReplaceProductCompatibilityAsync($sku, $content_language, $compatibility)
    {
        return $this->createOrReplaceProductCompatibilityAsyncWithHttpInfo($sku, $content_language, $compatibility)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrReplaceProductCompatibilityAsyncWithHttpInfo($sku, $content_language, $compatibility)
    {
        $returnType = '\OpenAPI\EbayInventoryClient\Model\BaseResponse';
        $request = $this->createOrReplaceProductCompatibilityRequest($sku, $content_language, $compatibility);
     ...
     */
    public function createOrReplaceProductCompatibilityRequest($sku, $content_language, $compatibility)
    {
