...
class Dimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'height' => 'float',
        'length' => 'float',
        'unit' => '\OpenAPI\EbayInventoryClient\Model\LengthUnitOfMeasureEnum',
        'width' => 'float'
    ];
     ...
     * Gets unit
     *
     * @return \OpenAPI\EbayInventoryClient\Model\LengthUnitOfMeasureEnum|null
     */
     ...
     * Sets unit
     *
     * @param \OpenAPI\EbayInventoryClient\Model\LengthUnitOfMeasureEnum|null $unit unit
     *
     * @return self
     */
