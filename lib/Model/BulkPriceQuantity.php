...
class BulkPriceQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'requests' => '\OpenAPI\EbayInventoryClient\Model\PriceQuantity[]'
    ];
    ...
    */
     ...
     * Gets requests
     *
     * @return \OpenAPI\EbayInventoryClient\Model\PriceQuantity[]|null
     */
     ...
     * Sets requests
     *
     * @param \OpenAPI\EbayInventoryClient\Model\PriceQuantity[]|null $requests This container is used by the seller to update the total 'ship-to-home' quantity of one or more inventory items (up to 25) and/or to update the price and/or quantity of one or more specific published offers.
     *
     * @return self
     */
