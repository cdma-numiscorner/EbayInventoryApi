...
class InventoryItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'href' => 'string',
        'inventory_items' => '\OpenAPI\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupid[]',
        'limit' => 'int',
        'next' => 'string',
        'prev' => 'string',
        'size' => 'int',
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupid[] $inventory_items This container is an array of one or more inventory items, with detailed information on each inventory item.
     *
     * @return self
     */
