...
class BulkOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets requests
     *
     * @return \OpenAPI\EbayInventoryClient\Model\OfferKeyWithId[]
     */
     ...
     * Sets requests
     *
     * @param \OpenAPI\EbayInventoryClient\Model\OfferKeyWithId[] $requests This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one <strong>bulkPublishOffer</strong> method.
     *
     * @return self
     */
