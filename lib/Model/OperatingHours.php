...
class OperatingHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\DayOfWeekEnum|null $day_of_week_enum day_of_week_enum
     *
     * @return self
     */
