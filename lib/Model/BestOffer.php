...
class BestOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'auto_accept_price' => '\OpenAPI\EbayInventoryClient\Model\Amount',
        'auto_decline_price' => '\OpenAPI\EbayInventoryClient\Model\Amount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('auto_decline_price', $data ?? [], null);
        $this->setIfExists('best_offer_enabled', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\Amount|null $auto_accept_price auto_accept_price
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\Amount|null $auto_decline_price auto_decline_price
     *
     * @return self
     */
    public function setAutoDeclinePrice($auto_decline_price)
    {
        if (is_null($auto_decline_price)) {
            throw new \InvalidArgumentException('non-nullable auto_decline_price cannot be null');
        }
    ...
    {
        if (is_null($best_offer_enabled)) {
            throw new \InvalidArgumentException('non-nullable best_offer_enabled cannot be null');
        }
