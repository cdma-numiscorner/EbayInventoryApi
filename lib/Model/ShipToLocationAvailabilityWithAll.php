...
class ShipToLocationAvailabilityWithAll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'allocation_by_format' => '\OpenAPI\EbayInventoryClient\Model\FormatAllocation',
        'availability_distributions' => '\OpenAPI\EbayInventoryClient\Model\AvailabilityDistribution[]',
        'quantity' => 'int'
    ];
    ...
    protected static array $openAPINullables = [
        'allocation_by_format' => false,
		'availability_distributions' => false,
		'quantity' => false
    ];
    ...
    {
        $this->setIfExists('allocation_by_format', $data ?? [], null);
        $this->setIfExists('availability_distributions', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\FormatAllocation|null
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\FormatAllocation|null $allocation_by_format allocation_by_format
     *
     * @return self
     */
    public function setAllocationByFormat($allocation_by_format)
    {
        if (is_null($allocation_by_format)) {
            throw new \InvalidArgumentException('non-nullable allocation_by_format cannot be null');
        }
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\AvailabilityDistribution[]|null
     */
