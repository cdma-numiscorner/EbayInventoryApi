...
class EbayOfferDetailsWithKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool|null $hide_buyer_details This field is included and set to true if the seller wishes to create a private listing. Sellers may want to use this option when they believe that a listing's potential bidders/buyers would not want their obfuscated user IDs (and feedback scores) exposed to other users.
     *
     * @return self
     */
