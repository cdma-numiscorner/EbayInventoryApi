...
class OfferResponseWithListingId implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $errors This container will be returned if there were one or more errors associated with publishing the offer.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $warnings This container will be returned if there were one or more warnings associated with publishing the offer.
     *
     * @return self
     */
