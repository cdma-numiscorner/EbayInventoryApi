...
class MigrateListingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]',
        ...
        'status_code' => 'int',
        'warnings' => '\OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventory_items'] === null) {
            $invalidProperties[] = "'inventory_items' can't be null";
        }
     ...
     * Gets errors
     *
     * @return \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\InventoryItemListing[]
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return self
     */
