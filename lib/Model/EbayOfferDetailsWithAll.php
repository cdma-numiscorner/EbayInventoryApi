...
class EbayOfferDetailsWithAll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sku' => 'string',
        'status' => '\OpenAPI\EbayInventoryClient\Model\OfferStatusEnum',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hide_buyer_details'] === null) {
            $invalidProperties[] = "'hide_buyer_details' can't be null";
        }
        if ($this->container['include_catalog_product_details'] === null) {
            $invalidProperties[] = "'include_catalog_product_details' can't be null";
        }
        if ($this->container['listing_duration'] === null) {
            $invalidProperties[] = "'listing_duration' can't be null";
        }
        if ($this->container['listing_policies'] === null) {
            $invalidProperties[] = "'listing_policies' can't be null";
        }
        ...
        if ($this->container['pricing_summary'] === null) {
            $invalidProperties[] = "'pricing_summary' can't be null";
        }
     ...
     * Gets format
     *
     * @return \OpenAPI\EbayInventoryClient\Model\FormatTypeEnum
     */
     ...
     * Sets format
     *
     * @param \OpenAPI\EbayInventoryClient\Model\FormatTypeEnum $format format
     *
     * @return self
     */
     ...
     *
     * @param string|null $listing_description The description of the eBay listing that is part of the unpublished or published offer. This field is always returned for published offers, but is only returned if set for unpublished offers.<br><br><strong>Maximum length</strong>: 500,000 (which includes HTML markup/tags)
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\ListingDurationEnum
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ListingDurationEnum $listing_duration listing_duration
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\ListingPolicies
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ListingPolicies $listing_policies listing_policies
     *
     * @return self
     */
     ...
     * Gets marketplace_id
     *
     * @return \OpenAPI\EbayInventoryClient\Model\MarketplaceEnum
     */
     ...
     * Sets marketplace_id
     *
     * @param \OpenAPI\EbayInventoryClient\Model\MarketplaceEnum $marketplace_id marketplace_id
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\PricingSummary
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\PricingSummary $pricing_summary pricing_summary
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string $sku This is the seller-defined SKU value of the product in the offer.<br><br><strong>Maximum length</strong>: 50 <br>
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\EbayInventoryClient\Model\OfferStatusEnum
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\EbayInventoryClient\Model\OfferStatusEnum $status status
     *
     * @return self
     */
