...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets document_id
     *
     * @param string|null $document_id The unique identifier of a regulatory document associated with the listing.<br><br>This value can be found in the response of the <a href=\"/develop/api/sell/media_api#sell-media_api-document-createdocument\" target=\"_blank\">createDocument</a> method of the Media API.
     *
     * @return self
     */
