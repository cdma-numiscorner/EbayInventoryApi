...
class LocationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets next
     *
     * @param string|null $next The URI for the following page of results. This value is returned only if there is an additional page of results to display from the result set. <br><br><b>Maximum length</b>: 2048
     *
     * @return self
     */
     ...
     * Sets prev
     *
     * @param string|null $prev The URI for the preceding page of results. This value is returned only if there is a previous page of results to display from the result set. <br><br><b>Maximum length</b>: 2048
     *
     * @return self
     */
