...
class InventoryLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets location_types
     *
     * @param \OpenAPI\EbayInventoryClient\Model\StoreTypeEnum[]|null $location_types This container is used to update the location type(s) associated with an inventory location.
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_web_url This text field is used by the merchant to provide/update the Website address (URL) associated with the inventory location. The URL that is passed in this field will replace any other URL that may be defined for this field. <br><br><b>Maximum length</b>: 512
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone This text field is used by the merchant to provide/update the phone number for the inventory location. The phone number that is passed in this field will replace any other phone number that may be defined for this field. <br><br><b>Maximum length</b>: 36
     *
     * @return self
     */
     ...
     * Sets time_zone_id
     *
     * @param string|null $time_zone_id This field is used to provide/update the time zone of the inventory location being created. This value should be in Olson format (for example <code>America/Vancouver</code>). For supported values, see <a href=\"https://howtodoinjava.com/java/date-time/supported-zone-ids-offsets/#3-java-supported-zone-ids-and-offsets\" target=\"_blank\">Java Supported Zone Ids and Offsets</a>.<br><br><span class=\"tablenote\"><b>Note:</b> If specified, this time zone will be used for all hour related fields. If this field is not specified, the time zone will be calculated from the provided address fields.</span>
     *
     * @return self
     */
