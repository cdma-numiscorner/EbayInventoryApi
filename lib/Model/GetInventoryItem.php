 ...
 */
class GetInventoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInventoryItem';
     ...
     * Sets sku
     *
     * @param string|null $sku An array of SKU values are passed in under the <strong>sku</strong> container to retrieve up to 25 inventory item records.<br><br>Use the <a href=\"/develop/api/sell/inventory_api#sell-inventory_api-inventory_item-getinventoryitems\" target=\"_blank \">getInventoryItems</a> method to retrieve SKU values.
     *
     * @return self
     */
