...
class PriceQuantityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $errors This array will be returned if there were one or more errors associated with the update to the offer or inventory item record.
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string $sku This is the seller-defined SKU value of the product. This field is returned whether the seller attempted to update an offer with the SKU value or just attempted to update the total 'ship-to-home' quantity of an inventory item record.<br><br><strong>Maximum length</strong>: 50<br>
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $warnings This array will be returned if there were one or more warnings associated with the update to the offer or inventory item record.
     *
     * @return self
     */
