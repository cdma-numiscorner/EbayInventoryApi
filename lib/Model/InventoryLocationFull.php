...
class InventoryLocationFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets location
     *
     * @return \OpenAPI\EbayInventoryClient\Model\LocationDetails
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\EbayInventoryClient\Model\LocationDetails $location location
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_additional_information This text field is used by the merchant to provide additional information about an inventory location. <br><br><b>Maximum length</b>: 256
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_web_url This text field is used by the merchant to provide the Website address (URL) associated with the inventory location. <br><br><b>Maximum length</b>: 512
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\StatusEnum|null
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\StatusEnum|null $merchant_location_status merchant_location_status
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string $phone This field is used to specify the phone number for an inventory location.<br><br><b>Maximum length</b>: 36
     *
     * @return self
     */
