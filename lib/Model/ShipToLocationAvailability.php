...
class ShipToLocationAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\AvailabilityDistribution[]|null $availability_distributions This container is used to set the available quantity of the inventory item at one or more warehouse locations. This container will be returned if available quantity is set for one or more inventory locations.
     *
     * @return self
     */
