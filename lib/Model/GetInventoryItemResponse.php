...
class GetInventoryItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'inventory_item' => '\OpenAPI\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupKeys',
        'sku' => 'string',
        'status_code' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inventory_item'] = $data['inventory_item'] ?? null;
     ...
     * Sets errors
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $errors This container will be returned if there were one or more errors associated with retrieving the inventory item record.
     *
     * @return self
     */
     ...
     * Gets inventory_item
     *
     * @return \OpenAPI\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupKeys
     */
     ...
     * Sets inventory_item
     *
     * @param \OpenAPI\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupKeys $inventory_item inventory_item
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorDetailV3[]|null $warnings This container will be returned if there were one or more warnings associated with retrieving the inventory item record.
     *
     * @return self
     */
