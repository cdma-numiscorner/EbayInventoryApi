...
/**
 * ErrorDetailV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class ErrorDetailV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorDetailV3';
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\OpenAPI\EbayInventoryClient\Model\ErrorParameterV3[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \OpenAPI\EbayInventoryClient\Model\ErrorParameterV3[]|null
     */
     ...
     * Sets parameters
     *
     * @param \OpenAPI\EbayInventoryClient\Model\ErrorParameterV3[]|null $parameters Various warning and error messages return one or more variables that contain contextual information about the error or warning. This is often the field or value that triggered the error or warning.
     *
     * @return self
     */
