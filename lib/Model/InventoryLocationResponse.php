...
class InventoryLocationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'location' => '\OpenAPI\EbayInventoryClient\Model\Location',
        'location_additional_information' => 'string',
        'location_instructions' => 'string',
        'location_types' => '\OpenAPI\EbayInventoryClient\Model\StoreTypeEnum[]',
        'location_web_url' => 'string',
        'merchant_location_key' => 'string',
        'merchant_location_status' => '\OpenAPI\EbayInventoryClient\Model\StatusEnum',
        'name' => 'string',
        ...
        'time_zone_id' => 'string',
        'fulfillment_center_specifications' => '\OpenAPI\EbayInventoryClient\Model\FulfillmentCenterSpecifications'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fulfillment_center_specifications'] = $data['fulfillment_center_specifications'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['merchant_location_status'] === null) {
            $invalidProperties[] = "'merchant_location_status' can't be null";
        }
     ...
     * Gets location
     *
     * @return \OpenAPI\EbayInventoryClient\Model\Location
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\EbayInventoryClient\Model\Location $location location
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_additional_information This text field provides additional information about an inventory location. This field is returned if it is set for the location.
     *
     * @return self
     */
     ...
     * Gets location_types
     *
     * @return \OpenAPI\EbayInventoryClient\Model\StoreTypeEnum[]|null
     */
     ...
     * Sets location_types
     *
     * @param \OpenAPI\EbayInventoryClient\Model\StoreTypeEnum[]|null $location_types This container defines the function of the inventory location. Typically, a location will serve as a store, warehouse, or fulfillment center, but in some cases, an inventory location may be more than one type.
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_web_url This text field shows the  Website address (URL) associated with the inventory location. This field is returned if defined for the location.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\StatusEnum
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\StatusEnum $merchant_location_status merchant_location_status
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\OperatingHours[]|null $operating_hours This container shows the regular operating hours for a store location during the days of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container is shown for each day of the week that the location is open.
     *
     * @return self
     */
     ...
     * Sets special_hours
     *
     * @param \OpenAPI\EbayInventoryClient\Model\SpecialHours[]|null $special_hours This container shows the special operating hours for a store or fulfillment center location on a specific date or dates.
     *
     * @return self
     */
     ...
     * Sets time_zone_id
     *
     * @param string|null $time_zone_id This field specifies the time zone of the inventory location being created. This value should be in Olson format (for example <code>America/Vancouver</code>). For supported values, see <a href=\"https://howtodoinjava.com/java/date-time/supported-zone-ids-offsets/#3-java-supported-zone-ids-and-offsets\" target=\"_blank\">Java Supported Zone Ids and Offsets</a>.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayInventoryClient\Model\FulfillmentCenterSpecifications|null
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\FulfillmentCenterSpecifications|null $fulfillment_center_specifications fulfillment_center_specifications
     *
     * @return self
     */
