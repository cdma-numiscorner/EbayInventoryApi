...
class InventoryLocationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets location
     *
     * @return \OpenAPI\EbayInventoryClient\Model\Location|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\EbayInventoryClient\Model\Location|null $location location
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayInventoryClient\Model\OperatingHours[]|null $operating_hours This container shows the regular operating hours for a store location during the days of the week. A dayOfWeekEnum field and an intervals container is shown for each day of the week that the store location is open.
     *
     * @return self
     */
     ...
     * Sets special_hours
     *
     * @param \OpenAPI\EbayInventoryClient\Model\SpecialHours[]|null $special_hours This container shows the special operating hours for a store location on a specific date or dates.
     *
     * @return self
     */
