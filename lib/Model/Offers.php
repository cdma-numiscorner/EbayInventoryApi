...
class Offers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets limit
     *
     * @param int $limit This integer value is the number of offers that will be displayed on each results page.
     *
     * @return self
     */
     ...
     * Sets offers
     *
     * @param \OpenAPI\EbayInventoryClient\Model\EbayOfferDetailsWithAll[] $offers This container is an array of one or more of the seller's offers for the SKU value that is passed in through the required <strong>sku</strong> query parameter.<br><br><span class=\"tablenote\"> <strong>Note:</strong> Currently, the Inventory API does not support the same SKU across multiple eBay marketplaces.</span><br><strong>Max Occurs:</strong> 25
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int $size This integer value indicates the number of offers being displayed on the current page of results. This number will generally be the same as the <strong>limit</strong> value if there are additional pages of results to view.  <br><br><span class=\"tablenote\"><strong>Note:</strong> The same SKU can be offered through an auction and a fixed-price listing concurrently. If this is the case, <b>getOffers</b> will return two offers and this value will be <code>2</code>. Otherwise, only one offer will be returned and this value will be <code>1</code>.</span>
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total This integer value is the total number of offers that exist for the specified SKU value. Based on this number and on the <strong>limit</strong> value, the seller may have to toggle through multiple pages to view all offers. <br><br><span class=\"tablenote\"><strong>Note:</strong> The same SKU can be offered through an auction and a fixed-price listing concurrently. If this is the case, <b>getOffers</b> will return two offers, so this value would be <code>2</code>. Otherwise, only one offer will be returned and this value will be <code>1</code>.</span>
     *
     * @return self
     */
