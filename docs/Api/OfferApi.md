...
$bulk_offer = new \OpenAPI\EbayInventoryClient\Model\BulkOffer(); // \OpenAPI\EbayInventoryClient\Model\BulkOffer | The base request of the bulkPublishOffer method.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_offer** | [**\OpenAPI\EbayInventoryClient\Model\BulkOffer**](../Model/BulkOffer.md)| The base request of the bulkPublishOffer method. |
...
```php
getOffers($sku, $marketplace_id, $format, $limit, $offset): \OpenAPI\EbayInventoryClient\Model\Offers
```
...
```php
updateOffer($offer_id, $content_language, $ebay_offer_details_with_id): \OpenAPI\EbayInventoryClient\Model\OfferResponse
```
...
$withdraw_by_inventory_item_group_request = new \OpenAPI\EbayInventoryClient\Model\WithdrawByInventoryItemGroupRequest(); // \OpenAPI\EbayInventoryClient\Model\WithdrawByInventoryItemGroupRequest | The base request of the withdrawOfferByInventoryItemGroup call.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **withdraw_by_inventory_item_group_request** | [**\OpenAPI\EbayInventoryClient\Model\WithdrawByInventoryItemGroupRequest**](../Model/WithdrawByInventoryItemGroupRequest.md)| The base request of the withdrawOfferByInventoryItemGroup call. |
